...
/*   Updated: 2017/12/01 01:07:43 by briviere         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static char	*ft_stoa_human_bin_sub(size_t nb, size_t dec)
{
	char	*nbr_str;
	char	*dec_str;
	char	*tmp_str;
...
char		*ft_stoa_human_bin(size_t nb)
{
	char	*nb_str;
	char	*tmp;
	char	metric[2];
	...
	tmp = ft_stoa_human_bin_sub(nb, prev);
